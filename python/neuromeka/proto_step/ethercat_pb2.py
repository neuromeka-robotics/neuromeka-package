...
_ETHERCAT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetEndtoolRS485RxFor',
    full_name='Nrmk.IndyFramework.EtherCAT.GetEndtoolRS485RxFor',
    index=27,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetEndtoolRS485TxFor',
    full_name='Nrmk.IndyFramework.EtherCAT.GetEndtoolRS485TxFor',
    index=29,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=common__msgs__pb2._ENDTOOLRS485TX,
  ...
  _descriptor.MethodDescriptor(
    name='GetAI',
    full_name='Nrmk.IndyFramework.EtherCAT.GetAI',
    index=40,
    containing_service=None,
    input_type=ethercat__msgs__pb2._AIOINDEX,
    output_type=ethercat__msgs__pb2._AIOANALOGINPUT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetAO',
    full_name='Nrmk.IndyFramework.EtherCAT.GetAO',
    index=41,
    containing_service=None,
    input_type=ethercat__msgs__pb2._AIOINDEX,
    output_type=ethercat__msgs__pb2._AIOANALOGOUTPUT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SetAO',
    full_name='Nrmk.IndyFramework.EtherCAT.SetAO',
    index=42,
    containing_service=None,
    input_type=ethercat__msgs__pb2._AIOANALOGOUTPUT,
    output_type=common__msgs__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SetZenHandRx',
    full_name='Nrmk.IndyFramework.EtherCAT.SetZenHandRx',
    index=43,
    containing_service=None,
    input_type=ethercat__msgs__pb2._ZENHANDRX,
    output_type=common__msgs__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetZenHandTx',
    full_name='Nrmk.IndyFramework.EtherCAT.GetZenHandTx',
    index=44,
    containing_service=None,
    input_type=ethercat__msgs__pb2._HANDINDEX,
    output_type=ethercat__msgs__pb2._ZENHANDTX,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetZenHandRx',
    full_name='Nrmk.IndyFramework.EtherCAT.GetZenHandRx',
    index=45,
    containing_service=None,
    input_type=ethercat__msgs__pb2._HANDINDEX,
    output_type=ethercat__msgs__pb2._ZENHANDRX,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetZenHandSensor',
    full_name='Nrmk.IndyFramework.EtherCAT.GetZenHandSensor',
    index=46,
    containing_service=None,
    input_type=ethercat__msgs__pb2._HANDINDEX,
    output_type=ethercat__msgs__pb2._ZENHANDSENSOR,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
