...
_DEVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SimDIConfig',
    full_name='Nrmk.IndyFramework.Device.SimDIConfig',
    index=3,
    containing_service=None,
    input_type=device__msgs__pb2._DISIGNALS,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  ...
  _descriptor.MethodDescriptor(
    name='GetEndRS485RxFor',
    full_name='Nrmk.IndyFramework.Device.GetEndRS485RxFor',
    index=15,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetEndRS485TxFor',
    full_name='Nrmk.IndyFramework.Device.GetEndRS485TxFor',
    index=17,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=common__msgs__pb2._ENDTOOLRS485TX,
  ...
  _descriptor.MethodDescriptor(
    name='GetSanderCommandFor',
    full_name='Nrmk.IndyFramework.Device.GetSanderCommandFor',
    index=31,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=device__msgs__pb2._SANDERCOMMAND,
  ...
  _descriptor.MethodDescriptor(
    name='GetFTSensorDataFor',
    full_name='Nrmk.IndyFramework.Device.GetFTSensorDataFor',
    index=33,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=device__msgs__pb2._FTSENSORDATA,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Device.SetConveyorLockedJoint',
    index=40,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Device.SetConveyorToolLink',
    index=41,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='SetConveyorArmIndex',
    full_name='Nrmk.IndyFramework.Device.SetConveyorArmIndex',
    index=42,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Device.GetConveyorObjectDistances',
    index=46,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='CommitViolation',
    full_name='Nrmk.IndyFramework.Device.CommitViolation',
    index=54,
    containing_service=None,
    input_type=device__msgs__pb2._VIOLATIONREQUEST,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  ...
  _descriptor.MethodDescriptor(
    name='GetGripperDataFor',
    full_name='Nrmk.IndyFramework.Device.GetGripperDataFor',
    index=56,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=device__msgs__pb2._GRIPPERDATA,
  ...
  _descriptor.MethodDescriptor(
    name='ConfigurePickit3D',
    full_name='Nrmk.IndyFramework.Device.ConfigurePickit3D',
    index=61,
    containing_service=None,
    input_type=device__msgs__pb2._CONFIGUREPICKIT3DREQ,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetPickit3DDetection',
    full_name='Nrmk.IndyFramework.Device.GetPickit3DDetection',
    index=62,
    containing_service=None,
    input_type=device__msgs__pb2._VISIONREQUEST,
    output_type=device__msgs__pb2._VISIONRESULT,
  ...
  _descriptor.MethodDescriptor(
    name='GetPickit3DRetrieval',
    full_name='Nrmk.IndyFramework.Device.GetPickit3DRetrieval',
    index=63,
    containing_service=None,
    input_type=device__msgs__pb2._VISIONREQUEST,
    output_type=device__msgs__pb2._VISIONRESULT,
  ...
  _descriptor.MethodDescriptor(
    name='GetRTTaskTimes',
    full_name='Nrmk.IndyFramework.Device.GetRTTaskTimes',
    index=64,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._TASKTIMES,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SocketCmdSetConfig',
    full_name='Nrmk.IndyFramework.Device.SocketCmdSetConfig',
    index=65,
    containing_service=None,
    input_type=device__msgs__pb2._SOCKETCOMMANDCONFIG,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SocketCmdGetConfig',
    full_name='Nrmk.IndyFramework.Device.SocketCmdGetConfig',
    index=66,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._SOCKETCOMMANDCONFIG,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SocketCmdStart',
    full_name='Nrmk.IndyFramework.Device.SocketCmdStart',
    index=67,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._SOCKETCOMMANDSTATUS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SocketCmdStop',
    full_name='Nrmk.IndyFramework.Device.SocketCmdStop',
    index=68,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._SOCKETCOMMANDSTATUS,
  ...
  _descriptor.MethodDescriptor(
    name='SocketCmdSendData',
    full_name='Nrmk.IndyFramework.Device.SocketCmdSendData',
    index=69,
    containing_service=None,
    input_type=device__msgs__pb2._SOCKETPAYLOAD,
    output_type=device__msgs__pb2._SOCKETCOMMANDSTATUS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SocketCmdGetLatestData',
    full_name='Nrmk.IndyFramework.Device.SocketCmdGetLatestData',
    index=70,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._SOCKETPAYLOAD,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SetInspireHandCommand',
    full_name='Nrmk.IndyFramework.Device.SetInspireHandCommand',
    index=71,
    containing_service=None,
    input_type=device__msgs__pb2._INSPIREHANDCOMMAND,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetInspireHandState',
    full_name='Nrmk.IndyFramework.Device.GetInspireHandState',
    index=72,
    containing_service=None,
    input_type=common__msgs__pb2._INT,
    output_type=device__msgs__pb2._INSPIREHANDSTATE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
