...
_DEVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetDOChannels',
    full_name='Nrmk.IndyFramework.Device.GetDOChannels',
    index=5,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=device__msgs__pb2._DOCHANNELMODES,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='SetDOChannels',
    full_name='Nrmk.IndyFramework.Device.SetDOChannels',
    index=6,
    containing_service=None,
    input_type=device__msgs__pb2._DOCHANNELMODES,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
