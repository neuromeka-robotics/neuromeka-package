...
_CRI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='StartCRIRecord',
    full_name='Nrmk.IndyFramework.CRI.StartCRIRecord',
    index=16,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='StopCRIRecord',
    full_name='Nrmk.IndyFramework.CRI.StopCRIRecord',
    index=17,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='StartCRIPlayback',
    full_name='Nrmk.IndyFramework.CRI.StartCRIPlayback',
    index=18,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='StopCRIPlayback',
    full_name='Nrmk.IndyFramework.CRI.StopCRIPlayback',
    index=19,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='GetCRIRecordMode',
    full_name='Nrmk.IndyFramework.CRI.GetCRIRecordMode',
    index=20,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=cri__msgs__pb2._CRIRECORDMODESTATE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
