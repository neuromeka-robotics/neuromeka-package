...
_CONTROL = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Control.SetComplianceMode',
    index=29,
    containing_service=None,
    input_type=control__msgs__pb2._COMPLIANCEMODE,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    full_name='Nrmk.IndyFramework.Control.GetComplianceMode',
    index=30,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=control__msgs__pb2._COMPLIANCEMODE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Reset',
    full_name='Nrmk.IndyFramework.Control.Reset',
    index=32,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='ResumeProgramDebug',
    full_name='Nrmk.IndyFramework.Control.ResumeProgramDebug',
    index=39,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='SetProgramBreakPoints',
    full_name='Nrmk.IndyFramework.Control.SetProgramBreakPoints',
    index=45,
    containing_service=None,
    input_type=common__msgs__pb2._PROGRAMBREAKPOINTS,
    output_type=common__msgs__pb2._RESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetProgramBreakPoints',
    full_name='Nrmk.IndyFramework.Control.GetProgramBreakPoints',
    index=46,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._PROGRAMBREAKPOINTS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ProgramStepOver',
    full_name='Nrmk.IndyFramework.Control.ProgramStepOver',
    index=47,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='ProgramStepInto',
    full_name='Nrmk.IndyFramework.Control.ProgramStepInto',
    index=48,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='ProgramStepOut',
    full_name='Nrmk.IndyFramework.Control.ProgramStepOut',
    index=49,
    containing_service=None,
    input_type=common__msgs__pb2._EMPTY,
    output_type=common__msgs__pb2._RESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='JointToTcpTransform',
    full_name='Nrmk.IndyFramework.Control.JointToTcpTransform',
    index=81,
    containing_service=None,
    input_type=control__msgs__pb2._JOINTTOTCPTRANSFORMREQ,
    output_type=control__msgs__pb2._JOINTTOTCPTRANSFORMRES,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
