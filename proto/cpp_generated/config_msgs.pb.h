...
class FTsensorFrame final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Nrmk.IndyFramework.FTsensorFrame) */ {
 public:
  inline FTsensorFrame() : FTsensorFrame(nullptr) {}
  ~FTsensorFrame() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR FTsensorFrame(::google::protobuf::internal::ConstantInitialized);

  FTsensorFrame(const FTsensorFrame& from);
  FTsensorFrame(FTsensorFrame&& from) noexcept
    : FTsensorFrame() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(FTsensorFrame& a, FTsensorFrame& b) {
    a.Swap(&b);
  }
  ...
  FTsensorFrame* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<FTsensorFrame>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const FTsensorFrame& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const FTsensorFrame& from) {
    FTsensorFrame::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "Nrmk.IndyFramework.FTsensorFrame";
  }
  protected:
...
class SafetyLimits final :
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<float>& joint_limits() const;
  ::google::protobuf::RepeatedField<float>* mutable_joint_limits();

  private:
  const ::google::protobuf::RepeatedField<float>& _internal_joint_limits() const;
  ::google::protobuf::RepeatedField<float>* _internal_mutable_joint_limits();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::google::protobuf::RepeatedField<float> joint_limits_;
    float power_limit_;
...
inline float FTsensorFrame::translation() const {
  // @@protoc_insertion_point(field_get:Nrmk.IndyFramework.FTsensorFrame.translation)
  return _internal_translation();
}
inline void FTsensorFrame::set_translation(float value) {
  _internal_set_translation(value);
  // @@protoc_insertion_point(field_set:Nrmk.IndyFramework.FTsensorFrame.translation)
}
...
inline float FTsensorFrame::rotation() const {
  // @@protoc_insertion_point(field_get:Nrmk.IndyFramework.FTsensorFrame.rotation)
  return _internal_rotation();
}
inline void FTsensorFrame::set_rotation(float value) {
  _internal_set_rotation(value);
  // @@protoc_insertion_point(field_set:Nrmk.IndyFramework.FTsensorFrame.rotation)
}
...
// repeated float joint_limits = 7;
inline int SafetyLimits::_internal_joint_limits_size() const {
  return _internal_joint_limits().size();
}
inline int SafetyLimits::joint_limits_size() const {
  return _internal_joint_limits_size();
}
inline void SafetyLimits::clear_joint_limits() {
  _internal_mutable_joint_limits()->Clear();
}
inline float SafetyLimits::joint_limits(int index) const {
  // @@protoc_insertion_point(field_get:Nrmk.IndyFramework.SafetyLimits.joint_limits)
  return _internal_joint_limits().Get(index);
}
inline void SafetyLimits::set_joint_limits(int index, float value) {
  _internal_mutable_joint_limits()->Set(index, value);
  // @@protoc_insertion_point(field_set:Nrmk.IndyFramework.SafetyLimits.joint_limits)
}
inline void SafetyLimits::add_joint_limits(float value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_joint_limits()->Add(value);
  // @@protoc_insertion_point(field_add:Nrmk.IndyFramework.SafetyLimits.joint_limits)
}
inline const ::google::protobuf::RepeatedField<float>& SafetyLimits::joint_limits() const {
  // @@protoc_insertion_point(field_list:Nrmk.IndyFramework.SafetyLimits.joint_limits)
  return _internal_joint_limits();
}
inline ::google::protobuf::RepeatedField<float>* SafetyLimits::mutable_joint_limits() {
  // @@protoc_insertion_point(field_mutable_list:Nrmk.IndyFramework.SafetyLimits.joint_limits)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_joint_limits();
}

inline const ::google::protobuf::RepeatedField<float>& SafetyLimits::_internal_joint_limits() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.joint_limits_;
}
inline ::google::protobuf::RepeatedField<float>* SafetyLimits::_internal_mutable_joint_limits() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.joint_limits_;
}
