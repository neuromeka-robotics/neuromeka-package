...
constexpr KinematicsParams_JointType KinematicsParams_JointType_JointType_MAX = static_cast<KinematicsParams_JointType>(1);
constexpr int KinematicsParams_JointType_JointType_ARRAYSIZE = 1 + 1;
const ::google::protobuf::EnumDescriptor*
